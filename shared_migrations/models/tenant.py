...
class Tenant(Base):
    ...
    model_analysis_requests = relationship(
        "ModelAnalysisRequest", back_populates="tenant", cascade="all, delete-orphan"
    )

    model_analysis_results = relationship("ModelAnalysisResult", back_populates="tenant", cascade="all, delete-orphan")
